...
Файлы скриншотов в репозитории:

- `docs/screenshots/menu.jpg`
- `docs/screenshots/gameplay.jpg`

### Скриншот 1. Состояние меню

![Состояние меню](screenshots/menu.jpg)

### Скриншот 2. Состояние игрового режима с тестовым примитивом

![Состояние игрового режима](screenshots/gameplay.jpg)

Дополнительно рекомендуется (при наличии) вставить:
